...
typedef Opha::Model<4,0,2,2> NoSpin;

// DO NOT TOUCH THIS FUNCTION.
// For a new model write your own.
template<>
void NoSpin::ODE_system::operator()(const state_t &state, state_t &derivatives_out, const double /*phi*/) const{
...
template<>
double NoSpin::emission_delay(const params_t& params, const state_t& impact_state, const double phi){
