...
M = 20000000000.*MSun
t0  = 1886.05*year
x0min,x0max = 0.016, 0.019
e0min,e0max = 0.60,0.68
u0min,u0max = 0.30,0.50
t0min,t0max = t0-300*day,t0+275*day
Mmin,Mmax = M*0.80, M*1.15
etamin,etamax = 0.0001,0.045
d1min,d1max = 0.35,0.95
ddmin,ddmax = -3.0e6/(365.25*24*3600),3.0e6/(365.25*24*3600)
