...
def save_aligned(year, ts, Ms):
    data = np.transpose([ts,Ms])
    filename = "aligned_{}.txt".format(year)
...
save_aligned(1984, tp_1984, Mp_1984)
plt.plot(t_t,M_t)
plt.scatter(tp_1984,Mp_1984)
plt.show()
##
...
save_aligned(1982, tp_1982, Mp_1982)
plt.plot(t_t,M_t)
plt.scatter(tp_1982,Mp_1982)
plt.show()
##
...
save_aligned(1912, tp_1912, Mp_1912)
plt.plot(t_t,M_t)
plt.scatter(tp_1912gedi,Mp_1912)
plt.show()
##
