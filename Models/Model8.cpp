...
typedef Opha::Model<4,0,3,2> Model8;

// DO NOT TOUCH THIS FUNCTION.
// For a new model write your own.
template<>
void Model8::ODE_system::operator()(const state_t &state, state_t &derivatives_out, const double /*phi*/) const{
...
template<>
double Model8::emission_delay(const params_t& params, const state_t& impact_state, const double phi){
...
template<>
std::array<double,3> Model8::coord_and_velocity(const params_t& params, const state_t& state, const double phi){
	const double 	r = 0,
			rdot = 0,
			phidot = 0;
